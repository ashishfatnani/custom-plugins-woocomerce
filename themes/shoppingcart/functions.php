...
// Include custom Zendesk integration
include_once(get_stylesheet_directory() . '/woo-zendesk-custom.php');

add_action('init', function () {
    if (isset($_GET['trigger_zendesk'])) {
        custom_create_zendesk_ticket(1234); // Replace with a real WooCommerce order ID
        exit('✅ Ticket triggered manually');
    }
});
